...
class PlatformReviewListCreateView(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        if limit:
            try:
                # Apply the same MAX_PAGE_SIZE cap (100) that was added
                # to the tenant-facing ReviewListCreateView (reviews/views.py).
    ...
    # Rate-limit unauthenticated review submissions. The global DRF
