...
class StaffDetailView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def perform_destroy(self, instance):
        ...
        # Guard was `user.role in ('staff', 'manager')` which
        ...
        # Flush all outstanding refresh tokens for this user
        ...
        try:
            ...
            # Log revocation failures so operators can detect when staff tokens remain valid post-removal
...
def _perform_staff_invite(request):
    ...
    # Normalize email to lowercase so that inviting "Jane@company.com"
