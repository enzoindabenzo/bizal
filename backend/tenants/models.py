...
class Tenant(models.Model):
    ...
    _RESERVED_SLUGS = frozenset({
        ...
        # Platform routes registered in bizal/urls.py that were
    ...
    def from_db(cls, db, field_names, values):
        """
        Cache the plan and business_type values at load time so
    ...
    def save(self, *args, **kwargs):
        ...
        if not is_new:
            try:
                # Use values cached by from_db() instead of a DB query.
            ...
            except Exception:  # pragma: no cover - defensive guard; self.plan/business_type
                # access cannot realistically raise once from_db() has populated
                # _loaded_plan/_loaded_business_type (or the getattr fallback kicks in).
                pass
    ...
    def _generate_referral_code(self):
        ...
        """
        # Use secrets.choice instead of random.choices. Referral
        ...
        # Referral codes. the previous fallback produced 14-char codes
    ...
    def has_feature(self, feature_key):
        ...
        # Return False for any tenant that has not yet been activated
...
class TenantLocation(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # Always enter the atomic+lock block regardless of is_primary value.
        ...
        # Lock ALL location rows for this tenant regardless of the
        # is_primary direction. Acquiring select_for_update() only on the
...
class TenantReferral(models.Model):
    ...
    def apply_credit(self):
        # Wrap the entire sequence in a single atomic block with
        ...
        with transaction.atomic():
            ...
            # Removed dead refresh_from_db() call. After the F()
