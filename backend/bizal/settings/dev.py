...
WARNING: Do NOT use this settings module directly on the host
...
# Updated comment; old wording implied spa still ran collectstatic
# but relied on the shared volume to avoid duplication, which was misleading.
#
# NOTE (): This dev-stack behaviour (spa reads web's manifest via
