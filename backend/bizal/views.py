...
def robots_txt(request):
    ...
    Return a tenant-aware robots.txt. The old version returned
    ...
    if request.tenant:
        ...
        # Derive scheme from the request so that during the
        ...
        # Sitemap_xml() always builds canonical URLs from
        ...
        lines = [
            ...
            'Disallow: /admin/',
            'Disallow: /account/',
            'Disallow: /onboarding/', # block onboarding on tenant subdomains
            '',
...
def sitemap_xml(request):
    ...
    # Always derive the sitemap authority from FRONTEND_BASE_URL
...
def health_check(request):
    ...
    try:
        # Connection.ensure_connection() was deprecated in Django 4.2
