...
def cancel_appointment(request, pk):
    ...
    # Use get_effective_role() so deactivated staff
    ...
    # bypassing the StaffMember.is_active guard. Mirrors the same fix applied
    # to cancel_booking.
    is_owner = (
    ...
    # Add 'no_show' to the terminal-state guard.
    # Mirrors the identical fix applied to cancel_booking.
...
def update_appointment_status(request, pk):
    ...
    # Enforce valid transition map. Terminal states
