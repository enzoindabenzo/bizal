...
// Expose internals for testing (harmless in production — same pattern as
// window.esc/window.escHtml above; nothing here is security-sensitive).
window.Theme = Theme;
window.toast = toast;
window.Modal = Modal;
