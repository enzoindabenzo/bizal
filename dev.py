...
print(f'  {GREEN}→{RESET}  http://localhost:8001/?tenant=barber-kings-tirana')
print(f'  {GREEN}→{RESET}  http://localhost:8001/?tenant=learning-center')
print(f'  {GREEN}→{RESET}  http://localhost:8001/?tenant=amos-realestate')
print(f'  {GREEN}→{RESET}  http://localhost:8001/?tenant=adriatic-tours')
print(f'  {GREEN}→{RESET}  http://localhost:8001/?tenant=ndertim-shpk  (trial)')
print(f'  {GREEN}→{RESET}  http://localhost:8001/?tenant=market-express')
print(f'  {GREEN}→{RESET}  http://localhost:8001/?tenant=hotel-riviera')
print()
print(f'  Admin: http://localhost:8000/admin  →  admin@bizal.al / <see SEED_ADMIN_PASSWORD or seed.py output>')
