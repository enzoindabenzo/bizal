...
diff the full transitive closure. That approach used to break CI for
reasons unrelated to any real mistake:

  - transitive packages get new patch releases on PyPI constantly, so a
    lockfile regenerated even an hour apart from CI's run could differ
